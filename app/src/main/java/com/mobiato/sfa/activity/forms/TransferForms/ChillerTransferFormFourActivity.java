...
public class ChillerTransferFormFourActivity extends BaseActivity implements View.OnClickListener {
       ...
       // setFullScreenBack();
        baseBinding.mToolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // onBackPressed();
                startActivity(new Intent(ChillerTransferFormFourActivity.this, ChillerTransferFormThreeActivity.class));
                finish();
            }
        });
        ...
        binding.chillerRequest.setVisibility(View.GONE);
        ...
        switch (v.getId()) {
            ...
            case R.id.btnTransferNext:
                if (checkNullValues()) {
                    ...
                    //addCustomer();
                    // startActivity(new Intent(ChillerTransferFormFourActivity.this, ChillerTransferFormTwoActivity.class));
                }
                break;
            default:
                break;
...
//        db.insertRecentCustomer(recentCustomer);
        ...
        startActivity(new Intent(ChillerTransferFormFourActivity.this, FragmentJourneyPlan.class));
